package de.alosdev.android.devfestist14.phone;
...
import de.alosdev.android.devfestist14.R;
    ...
    if (R.id.button == v.getId()) {
      ...
      new AsyncTask<String, Void, String>() {
        ...
        protected String doInBackground(String... params) {
          try {
            MyApi.Builder builder = new MyApi.Builder(AndroidHttp.newCompatibleTransport(), new GsonFactory(), null);
